 ...
 ******************************************************************************
 *  File                : hdulibstm32f746xx.h
 *
 *  Description         : CMSIS Cortex-M7 Device Peripheral Access Layer Header File.
 *                        This file contains:
 ...
 *      1.4          Rona B.S        10-Oct-2017            100064
 *
...
#ifndef _HDULIBSTM32F746XX_H_
#define _HDULIBSTM32F746XX_H_
...
typedef struct
{
  __IO T_UINT32 SR;     /* ADC status register,                         Address offset: 0x00 */
  __IO T_UINT32 CR1;    /* ADC control register 1,                      Address offset: 0x04 */
  __IO T_UINT32 CR2;    /* ADC control register 2,                      Address offset: 0x08 */
  __IO T_UINT32 SMPR1;  /* ADC sample time register 1,                  Address offset: 0x0C */
  __IO T_UINT32 SMPR2;  /* ADC sample time register 2,                  Address offset: 0x10 */
  __IO T_UINT32 JOFR1;  /* ADC injected channel data offset register 1, Address offset: 0x14 */
  __IO T_UINT32 JOFR2;  /* ADC injected channel data offset register 2, Address offset: 0x18 */
  __IO T_UINT32 JOFR3;  /* ADC injected channel data offset register 3, Address offset: 0x1C */
  __IO T_UINT32 JOFR4;  /* ADC injected channel data offset register 4, Address offset: 0x20 */
  __IO T_UINT32 HTR;    /* ADC watchdog higher threshold register,      Address offset: 0x24 */
  __IO T_UINT32 LTR;    /* ADC watchdog lower threshold register,       Address offset: 0x28 */
  __IO T_UINT32 SQR1;   /* ADC regular sequence register 1,             Address offset: 0x2C */
  __IO T_UINT32 SQR2;   /* ADC regular sequence register 2,             Address offset: 0x30 */
  __IO T_UINT32 SQR3;   /* ADC regular sequence register 3,             Address offset: 0x34 */
  __IO T_UINT32 JSQR;   /* ADC injected sequence register,              Address offset: 0x38*/
  __IO T_UINT32 JDR1;   /* ADC injected data register 1,                Address offset: 0x3C */
  __IO T_UINT32 JDR2;   /* ADC injected data register 2,                Address offset: 0x40 */
  __IO T_UINT32 JDR3;   /* ADC injected data register 3,                Address offset: 0x44 */
  __IO T_UINT32 JDR4;   /* ADC injected data register 4,                Address offset: 0x48 */
  __IO T_UINT32 DR;     /* ADC regular data register,                   Address offset: 0x4C */
} T_ADC;

typedef struct
{
  __IO T_UINT32 CSR;   /* ADC Common status register, Address offset: ADC1 base address + 0x300 */
  __IO T_UINT32 CCR;   /* ADC common control register, Address offset: ADC1 base address + 0x304 */
...
typedef struct
{
  __IO T_UINT32 TIR;  /* CAN TX mailbox identifier register */
  __IO T_UINT32 TDTR; /* CAN mailbox data length control and time stamp register */
  __IO T_UINT32 TDLR; /* CAN mailbox data low register */
  __IO T_UINT32 TDHR; /* CAN mailbox data high register */
} T_CAN_TXMAILBOX;

typedef struct
{
  __IO T_UINT32 RIR;  /* CAN receive FIFO mailbox identifier register */
  __IO T_UINT32 RDTR; /* CAN receive FIFO mailbox data length control and time stamp register */
  __IO T_UINT32 RDLR; /* CAN receive FIFO mailbox data low register */
  __IO T_UINT32 RDHR; /* CAN receive FIFO mailbox data high register */
} T_CAN_FIFOMAILBOX;


typedef struct
{
  __IO T_UINT32 FR1; /* CAN Filter bank register 1 */
  __IO T_UINT32 FR2; /* CAN Filter bank register 1 */
} T_CAN_FILTERREGISTER;


typedef struct
{
  __IO T_UINT32              MCR;      /* CAN master control register, Address offset: 0x00 */
  __IO T_UINT32              MSR;      /* CAN master status register, Address offset: 0x04 */
  __IO T_UINT32              TSR;      /* CAN transmit status register, Address offset: 0x08 */
  __IO T_UINT32              RF0R;     /* CAN receive FIFO 0 register, Address offset: 0x0C */
  __IO T_UINT32              RF1R;     /* CAN receive FIFO 1 register, Address offset: 0x10 */
  __IO T_UINT32              IER;      /* CAN interrupt enable register, Address offset: 0x14 */
  __IO T_UINT32              ESR;      /* CAN error status register, Address offset: 0x18 */
  __IO T_UINT32              BTR;      /* CAN bit timing register, Address offset: 0x1C */
  T_UINT32                   RESERVED0[88]; /* Reserved, 0x020 - 0x17F */
  T_CAN_TXMAILBOX      sTxMailBox[3]; /* CAN Tx MailBox, Address offset: 0x180 - 0x1AC */
  T_CAN_FIFOMAILBOX    sFIFOMailBox[2]; /* CAN FIFO MailBox, Address offset: 0x1B0 - 0x1CC */
  T_UINT32                   RESERVED1[12];   /* Reserved, 0x1D0 - 0x1FF */
  __IO T_UINT32              FMR;         /* CAN filter master register, Address offset: 0x200 */
  __IO T_UINT32              FM1R;        /* CAN filter mode register, Address offset: 0x204 */
  T_UINT32                   RESERVED2;   /* Reserved, 0x208 */
  __IO T_UINT32              FS1R;        /* CAN filter scale register, Address offset: 0x20C */
  T_UINT32                   RESERVED3;   /* Reserved, 0x210 */
  /* CAN filter FIFO assignment register, Address offset: 0x214 */
  __IO T_UINT32              FFA1R;
  T_UINT32                   RESERVED4;   /* Reserved, 0x218 */
  __IO T_UINT32              FA1R;     /* CAN filter activation register, Address offset: 0x21C */
  T_UINT32                   RESERVED5[8];/* Reserved, 0x220-0x23F */
  /* CAN Filter Register, Address offset: 0x240-0x31C */
  T_CAN_FILTERREGISTER sFilterRegister[28];
} T_CAN;

typedef struct
{
  __IO T_UINT32 CR;           /* CEC control register, Address offset:0x00 */
  __IO T_UINT32 CFGR;         /* CEC configuration register, Address offset:0x04 */
  __IO T_UINT32 TXDR;         /* CEC Tx data register , Address offset:0x08 */
  __IO T_UINT32 RXDR;         /* CEC Rx Data Register, Address offset:0x0C */
  __IO T_UINT32 ISR;          /* CEC Interrupt and Status Register, Address offset:0x10 */
  __IO T_UINT32 IER;          /* CEC interrupt enable register, Address offset:0x14 */
}T_CEC;


typedef struct
{
  __IO T_UINT32  DR;          /* CRC Data register, Address offset: 0x00 */
  __IO T_UINT8   IDR;         /* CRC Independent data register, Address offset: 0x04 */
  T_UINT8        RESERVED0;   /* Reserved, 0x05 */
  T_UINT16       RESERVED1;   /* Reserved, 0x06 */
  __IO T_UINT32  CR;          /* CRC Control register, Address offset: 0x08 */
  T_UINT32       RESERVED2;   /* Reserved, 0x0C */
  __IO T_UINT32  INIT;        /* Initial CRC value register, Address offset: 0x10 */
  __IO T_UINT32  POL;         /* CRC polynomial register, Address offset: 0x14 */
} T_CRC;

typedef struct
{
  __IO T_UINT32 CR;       /* DAC control register, Address offset: 0x00 */
  __IO T_UINT32 SWTRIGR;  /* DAC software trigger register, Address offset: 0x04 */
  /* DAC channel1 12-bit right-aligned data holding register, Address offset: 0x08 */
  __IO T_UINT32 DHR12R1;
  /* DAC channel1 12-bit left aligned data holding register,  Address offset: 0x0C */
  __IO T_UINT32 DHR12L1;
  /* DAC channel1 8-bit right aligned data holding register,  Address offset: 0x10 */
  __IO T_UINT32 DHR8R1;
  /* DAC channel2 12-bit right aligned data holding register, Address offset: 0x14 */
  __IO T_UINT32 DHR12R2;
  /* DAC channel2 12-bit left aligned data holding register,  Address offset: 0x18 */
  __IO T_UINT32 DHR12L2;
  /* DAC channel2 8-bit right-aligned data holding register,  Address offset: 0x1C */
  __IO T_UINT32 DHR8R2;
  /* Dual DAC 12-bit right-aligned data holding register, Address offset: 0x20 */
  __IO T_UINT32 DHR12RD;
  /* DUAL DAC 12-bit left aligned data holding register, Address offset: 0x24 */
  __IO T_UINT32 DHR12LD;
  /* DUAL DAC 8-bit right aligned data holding register, Address offset: 0x28 */
  __IO T_UINT32 DHR8RD;
  __IO T_UINT32 DOR1;     /* DAC channel1 data output register, Address offset: 0x2C */
  __IO T_UINT32 DOR2;     /* DAC channel2 data output register, Address offset: 0x30 */
  __IO T_UINT32 SR;       /* DAC status register, Address offset: 0x34 */
} T_DAC;


typedef struct
{
  __IO T_UINT32 IDCODE;  /* MCU device ID code, Address offset: 0x00 */
  __IO T_UINT32 CR;      /* Debug MCU configuration register, Address offset: 0x04 */
  __IO T_UINT32 APB1FZ;  /* Debug MCU APB1 freeze register, Address offset: 0x08 */
  __IO T_UINT32 APB2FZ;  /* Debug MCU APB2 freeze register, Address offset: 0x0C */
}T_DBGMCU;

typedef struct
{
  __IO T_UINT32 CR;       /* DCMI control register 1, Address offset: 0x00 */
  __IO T_UINT32 SR;       /* DCMI status register, Address offset: 0x04 */
  __IO T_UINT32 RISR;     /* DCMI raw interrupt status register, Address offset: 0x08 */
  __IO T_UINT32 IER;      /* DCMI interrupt enable register, Address offset: 0x0C */
  __IO T_UINT32 MISR;     /* DCMI masked interrupt status register, Address offset: 0x10 */
  __IO T_UINT32 ICR;      /* DCMI interrupt clear register, Address offset: 0x14 */
  __IO T_UINT32 ESCR;     /* DCMI embedded synchronization code register, Address offset: 0x18 */
  __IO T_UINT32 ESUR;     /* DCMI embedded synchronization unmask register, Address offset: 0x1C */
  __IO T_UINT32 CWSTRTR;  /* DCMI crop window start, Address offset: 0x20 */
  __IO T_UINT32 CWSIZER;  /* DCMI crop window size, Address offset: 0x24 */
  __IO T_UINT32 DR;       /* DCMI data register, Address offset: 0x28 */
} T_DCMI;

typedef struct
{
  __IO T_UINT32 CR;     /* DMA stream x configuration register */
  __IO T_UINT32 NDTR;   /* DMA stream x number of data register  */
  __IO T_UINT32 PAR;    /* DMA stream x peripheral address register */
  __IO T_UINT32 M0AR;   /* DMA stream x memory 0 address register   */
  __IO T_UINT32 M1AR;   /* DMA stream x memory 1 address register   */
  __IO T_UINT32 FCR;    /* DMA stream x FIFO control register  */
} T_DMA_STREAM;

typedef struct
{
  __IO T_UINT32 LISR;   /* DMA low interrupt status register,      Address offset: 0x00 */
  __IO T_UINT32 HISR;   /* DMA high interrupt status register,     Address offset: 0x04 */
  __IO T_UINT32 LIFCR;  /* DMA low interrupt flag clear register,  Address offset: 0x08 */
  __IO T_UINT32 HIFCR;  /* DMA high interrupt flag clear register, Address offset: 0x0C */
} T_DMA;

typedef struct
{
  __IO T_UINT32 CR;            /* DMA2D Control Register, Address offset: 0x00 */
  __IO T_UINT32 ISR;           /* DMA2D Interrupt Status Register, Address offset: 0x04 */
  __IO T_UINT32 IFCR;          /* DMA2D Interrupt Flag Clear Register, Address offset: 0x08 */
  __IO T_UINT32 FGMAR;         /* DMA2D Foreground Memory Address Register, Address offset: 0x0C */
  __IO T_UINT32 FGOR;          /* DMA2D Foreground Offset Register, Address offset: 0x10 */
  __IO T_UINT32 BGMAR;         /* DMA2D Background Memory Address Register, Address offset: 0x14 */
  __IO T_UINT32 BGOR;          /* DMA2D Background Offset Register, Address offset: 0x18 */
  __IO T_UINT32 FGPFCCR;       /* DMA2D Foreground PFC Control Register, Address offset: 0x1C */
  __IO T_UINT32 FGCOLR;        /* DMA2D Foreground Color Register, Address offset: 0x20 */
  __IO T_UINT32 BGPFCCR;       /* DMA2D Background PFC Control Register, Address offset: 0x24 */
  __IO T_UINT32 BGCOLR;        /* DMA2D Background Color Register, Address offset: 0x28 */
  /* DMA2D Foreground CLUT Memory Address Register, Address offset: 0x2C */
  __IO T_UINT32 FGCMAR;
  /* DMA2D Background CLUT Memory Address Register, Address offset: 0x30 */
  __IO T_UINT32 BGCMAR;
  __IO T_UINT32 OPFCCR;        /* DMA2D Output PFC Control Register, Address offset: 0x34 */
  __IO T_UINT32 OCOLR;         /* DMA2D Output Color Register, Address offset: 0x38 */
  __IO T_UINT32 OMAR;          /* DMA2D Output Memory Address Register, Address offset: 0x3C */
  __IO T_UINT32 OOR;           /* DMA2D Output Offset Register, Address offset: 0x40 */
  __IO T_UINT32 NLR;           /* DMA2D Number of Line Register, Address offset: 0x44 */
  __IO T_UINT32 LWR;           /* DMA2D Line Watermark Register, Address offset: 0x48 */
  /* DMA2D AHB Master Timer Configuration Register,  Address offset: 0x4C */
  __IO T_UINT32 AMTCR;
  T_UINT32      RESERVED[236]; /* Reserved, 0x50-0x3FF */
  __IO T_UINT32 FGCLUT[256];   /* DMA2D Foreground CLUT, Address offset:400-7FF */
  __IO T_UINT32 BGCLUT[256];   /* DMA2D Background CLUT, Address offset:800-BFF */
} T_DMA2D;

typedef struct
{
  __IO T_UINT32 MACCR;
  __IO T_UINT32 MACFFR;
  __IO T_UINT32 MACHTHR;
  __IO T_UINT32 MACHTLR;
  __IO T_UINT32 MACMIIAR;
  __IO T_UINT32 MACMIIDR;
  __IO T_UINT32 MACFCR;
  __IO T_UINT32 MACVLANTR;             /*    8 */
  T_UINT32      RESERVED0[2];
  __IO T_UINT32 MACRWUFFR;             /*   11 */
  __IO T_UINT32 MACPMTCSR;
  T_UINT32      RESERVED1[2];
  __IO T_UINT32 MACSR;                 /*   15 */
  __IO T_UINT32 MACIMR;
  __IO T_UINT32 MACA0HR;
  __IO T_UINT32 MACA0LR;
  __IO T_UINT32 MACA1HR;
  __IO T_UINT32 MACA1LR;
  __IO T_UINT32 MACA2HR;
  __IO T_UINT32 MACA2LR;
  __IO T_UINT32 MACA3HR;
  __IO T_UINT32 MACA3LR;               /*   24 */
  T_UINT32      RESERVED2[40];
  __IO T_UINT32 MMCCR;                 /*   65 */
  __IO T_UINT32 MMCRIR;
  __IO T_UINT32 MMCTIR;
  __IO T_UINT32 MMCRIMR;
  __IO T_UINT32 MMCTIMR;               /*   69 */
  T_UINT32      RESERVED3[14];
  __IO T_UINT32 MMCTGFSCCR;            /*   84 */
  __IO T_UINT32 MMCTGFMSCCR;
  T_UINT32      RESERVED4[5];
  __IO T_UINT32 MMCTGFCR;
  T_UINT32      RESERVED5[10];
  __IO T_UINT32 MMCRFCECR;
  __IO T_UINT32 MMCRFAECR;
  T_UINT32      RESERVED6[10];
  __IO T_UINT32 MMCRGUFCR;
  T_UINT32      RESERVED7[334];
  __IO T_UINT32 PTPTSCR;
  __IO T_UINT32 PTPSSIR;
  __IO T_UINT32 PTPTSHR;
  __IO T_UINT32 PTPTSLR;
  __IO T_UINT32 PTPTSHUR;
  __IO T_UINT32 PTPTSLUR;
  __IO T_UINT32 PTPTSAR;
  __IO T_UINT32 PTPTTHR;
  __IO T_UINT32 PTPTTLR;
  __IO T_UINT32 RESERVED8;
  __IO T_UINT32 PTPTSSR;
  T_UINT32      RESERVED9[565];
  __IO T_UINT32 DMABMR;
  __IO T_UINT32 DMATPDR;
  __IO T_UINT32 DMARPDR;
  __IO T_UINT32 DMARDLAR;
  __IO T_UINT32 DMATDLAR;
  __IO T_UINT32 DMASR;
  __IO T_UINT32 DMAOMR;
  __IO T_UINT32 DMAIER;
  __IO T_UINT32 DMAMFBOCR;
  __IO T_UINT32 DMARSWTR;
  T_UINT32      RESERVED10[8];
  __IO T_UINT32 DMACHTDR;
  __IO T_UINT32 DMACHRDR;
  __IO T_UINT32 DMACHTBAR;
  __IO T_UINT32 DMACHRBAR;
} T_ETH;


typedef struct
{
  __IO T_UINT32 IMR;    /* EXTI Interrupt mask register,            Address offset: 0x00 */
  __IO T_UINT32 EMR;    /* EXTI Event mask register,                Address offset: 0x04 */
  __IO T_UINT32 RTSR;   /* EXTI Rising trigger selection register,  Address offset: 0x08 */
  __IO T_UINT32 FTSR;   /* EXTI Falling trigger selection register, Address offset: 0x0C */
  __IO T_UINT32 SWIER;  /* EXTI Software interrupt event register,  Address offset: 0x10 */
  __IO T_UINT32 PR;     /* EXTI Pending register,                   Address offset: 0x14 */
} T_EXTI;

typedef struct
{
  __IO T_UINT32 ACR;      /* FLASH access control register,     Address offset: 0x00 */
  __IO T_UINT32 KEYR;     /* FLASH key register,                Address offset: 0x04 */
  __IO T_UINT32 OPTKEYR;  /* FLASH option key register,         Address offset: 0x08 */
  __IO T_UINT32 SR;       /* FLASH status register,             Address offset: 0x0C */
  __IO T_UINT32 CR;       /* FLASH control register,            Address offset: 0x10 */
  __IO T_UINT32 OPTCR;    /* FLASH option control register ,    Address offset: 0x14 */
  __IO T_UINT32 OPTCR1;   /* FLASH option control register 1 ,  Address offset: 0x18 */
} T_FLASH;
...
{
   /*
    * NOR/PSRAM chip-select control register(BCR) and chip-select
    * timing register(BTR), Address offset: 0x00-1C
    */
  __IO T_UINT32 BTCR[8];
} T_FMC_BANK1;


typedef struct
{
  __IO T_UINT32 BWTR[7];    /* NOR/PSRAM write timing registers, Address offset: 0x104-0x11C */
} T_FMC_BANK1E;

/* @brief Flexible Memory Controller Bank3 */
typedef struct
{
  __IO T_UINT32 PCR;     /* NAND Flash control register, Address offset: 0x80 */
  __IO T_UINT32 SR;      /* NAND Flash FIFO status and interrupt register, Address offset: 0x84 */
  __IO T_UINT32 PMEM;    /* NAND Flash Common memory space timing register, Address offset: 0x88 */
  /* NAND Flash Attribute memory space timing register, Address offset: 0x8C */
  __IO T_UINT32 PATT;
  T_UINT32      RESERVED0;  /* Reserved, 0x90 */
  __IO T_UINT32 ECCR;       /* NAND Flash ECC result registers, Address offset: 0x94 */
} T_FMC_BANK3;

/* @brief Flexible Memory Controller Bank5_6 */
typedef struct
{
  __IO T_UINT32 SDCR[2];        /* SDRAM Control registers ,      Address offset: 0x140-0x144  */
  __IO T_UINT32 SDTR[2];        /* SDRAM Timing registers ,       Address offset: 0x148-0x14C  */
  __IO T_UINT32 SDCMR;       /* SDRAM Command Mode register,    Address offset: 0x150  */
  __IO T_UINT32 SDRTR;       /* SDRAM Refresh Timer register,   Address offset: 0x154  */
  __IO T_UINT32 SDSR;        /* SDRAM Status register,          Address offset: 0x158  */
} T_FMC_BANK5_6;

/* @brief General Purpose I/O */
typedef struct
{
  __IO T_UINT32 MODER;    /* GPIO port mode register,               Address offset: 0x00 */
  __IO T_UINT32 OTYPER;   /* GPIO port output type register,        Address offset: 0x04 */
  __IO T_UINT32 OSPEEDR;  /* GPIO port output speed register,       Address offset: 0x08 */
  __IO T_UINT32 PUPDR;    /* GPIO port pull-up/pull-down register,  Address offset: 0x0C */
  __IO T_UINT32 IDR;      /* GPIO port input data register,         Address offset: 0x10 */
  __IO T_UINT32 ODR;      /* GPIO port output data register,        Address offset: 0x14 */
  __IO T_UINT32 BSRR;     /* GPIO port bit set/reset register,      Address offset: 0x18 */
  __IO T_UINT32 LCKR;     /* GPIO port configuration lock register, Address offset: 0x1C */
  __IO T_UINT32 AFR[2];   /* GPIO alternate function registers,     Address offset: 0x20-0x24 */
} T_GPIO;

/* @brief System configuration controller */
typedef struct
{
  __IO T_UINT32 MEMRMP;       /* SYSCFG memory remap register, Address offset: 0x00 */
  ...
  __IO T_UINT32 EXTICR[4];
  T_UINT32      RESERVED[2];  /* Reserved, 0x18-0x1C */
  __IO T_UINT32 CMPCR;        /* SYSCFG Compensation cell control register, Address offset: 0x20 */
} T_SYSCFG;

/* @brief Inter-integrated Circuit Interface */
typedef struct
{
  __IO T_UINT32 CR1;      /* I2C Control register 1,            Address offset: 0x00 */
  __IO T_UINT32 CR2;      /* I2C Control register 2,            Address offset: 0x04 */
  __IO T_UINT32 OAR1;     /* I2C Own address 1 register,        Address offset: 0x08 */
  __IO T_UINT32 OAR2;     /* I2C Own address 2 register,        Address offset: 0x0C */
  __IO T_UINT32 TIMINGR;  /* I2C Timing register,               Address offset: 0x10 */
  __IO T_UINT32 TIMEOUTR; /* I2C Timeout register,              Address offset: 0x14 */
  __IO T_UINT32 ISR;      /* I2C Interrupt and status register, Address offset: 0x18 */
  __IO T_UINT32 ICR;      /* I2C Interrupt clear register,      Address offset: 0x1C */
  __IO T_UINT32 PECR;     /* I2C PEC register,                  Address offset: 0x20 */
  __IO T_UINT32 RXDR;     /* I2C Receive data register,         Address offset: 0x24 */
  __IO T_UINT32 TXDR;     /* I2C Transmit data register,        Address offset: 0x28 */
} T_I2C;

/* @brief Independent WATCHDOG */
typedef struct
{
  __IO T_UINT32 KR;   /* IWDG Key register,       Address offset: 0x00 */
  __IO T_UINT32 PR;   /* IWDG Prescaler register, Address offset: 0x04 */
  __IO T_UINT32 RLR;  /* IWDG Reload register,    Address offset: 0x08 */
  __IO T_UINT32 SR;   /* IWDG Status register,    Address offset: 0x0C */
  __IO T_UINT32 WINR; /* IWDG Window register,    Address offset: 0x10 */
} T_IWDG;

/* @brief LCD-TFT Display Controller */
typedef struct
{
  T_UINT32      RESERVED0[2];  /* Reserved, 0x00-0x04 */
  /* LTDC Synchronization Size Configuration Register, Address offset: 0x08 */
  __IO T_UINT32 SSCR;
  __IO T_UINT32 BPCR;          /* LTDC Back Porch Configuration Register, Address offset: 0x0C */
  __IO T_UINT32 AWCR;          /* LTDC Active Width Configuration Register, Address offset: 0x10 */
  __IO T_UINT32 TWCR;          /* LTDC Total Width Configuration Register, Address offset: 0x14 */
  __IO T_UINT32 GCR;           /* LTDC Global Control Register, Address offset: 0x18 */
  T_UINT32      RESERVED1[2];  /* Reserved, 0x1C-0x20 */
  __IO T_UINT32 SRCR;          /* LTDC Shadow Reload Configuration Register, Address offset:0x24 */
  T_UINT32      RESERVED2[1];  /* Reserved, 0x28 */
  /* LTDC Background Color Configuration Register, Address offset: 0x2C */
  __IO T_UINT32 BCCR;
  T_UINT32      RESERVED3[1];  /* Reserved, 0x30 */
  __IO T_UINT32 IER;           /* LTDC Interrupt Enable Register, Address offset: 0x34 */
  __IO T_UINT32 ISR;           /* LTDC Interrupt Status Register, Address offset: 0x38 */
  __IO T_UINT32 ICR;           /* LTDC Interrupt Clear Register, Address offset: 0x3C */
  /* LTDC Line Interrupt Position Configuration Register, Address offset: 0x40 */
  __IO T_UINT32 LIPCR;
  __IO T_UINT32 CPSR;          /* LTDC Current Position Status Register, Address offset: 0x44 */
  __IO T_UINT32 CDSR;         /* LTDC Current Display Status Register, Address offset: 0x48 */
} T_LTDC;

/* @brief LCD-TFT Display layer x Controller */
typedef struct
{
  __IO T_UINT32 CR;            /* LTDC Layerx Control Register Address offset: 0x84 */
  ...
  __IO T_UINT32 WVPCR;
  __IO T_UINT32 CKCR;  /* LTDC Layerx Color Keying Configuration Register Address offset: 0x90 */
  __IO T_UINT32 PFCR;  /* LTDC Layerx Pixel Format Configuration Register Address offset: 0x94 */
  __IO T_UINT32 CACR;  /* LTDC Layerx Constant Alpha Configuration Register Address offset:0x98 */
  __IO T_UINT32 DCCR;  /* LTDC Layerx Default Color Configuration Register Address offset: 0x9C */
  __IO T_UINT32 BFCR;  /* LTDC Layerx Blending Factors Configuration Register Address offset:0xA0*/
  T_UINT32      RESERVED0[2];  /* Reserved */
  __IO T_UINT32 CFBAR;  /* LTDC Layerx Color Frame Buffer Address Register Address offset: 0xAC */
  __IO T_UINT32 CFBLR;  /* LTDC Layerx Color Frame Buffer Length Register Address offset: 0xB0 */
  __IO T_UINT32 CFBLNR; /* LTDC Layerx ColorFrame Buffer Line Number Register Address offset:0xB4*/
  T_UINT32      RESERVED1[3];  /* Reserved */
  __IO T_UINT32 CLUTWR;        /* LTDC Layerx CLUT Write Register Address offset: 0x144 */
...
typedef struct
{
  __IO T_UINT32 CR1;   /* PWR power control register 1,        Address offset: 0x00 */
  __IO T_UINT32 CSR1;  /* PWR power control/status register 2, Address offset: 0x04 */
  __IO T_UINT32 CR2;   /* PWR power control register 2,        Address offset: 0x08 */
  __IO T_UINT32 CSR2;  /* PWR power control/status register 2, Address offset: 0x0C */
} T_PWR;

/* @brief Reset and Clock Control */
typedef struct
{
  __IO T_UINT32 CR;            /* RCC clock control register, Address offset: 0x00 */
  __IO T_UINT32 PLLCFGR;       /* RCC PLL configuration register, Address offset: 0x04 */
  __IO T_UINT32 CFGR;          /* RCC clock configuration register, Address offset: 0x08 */
  __IO T_UINT32 CIR;           /* RCC clock interrupt register, Address offset: 0x0C */
  __IO T_UINT32 AHB1RSTR;      /* RCC AHB1 peripheral reset register, Address offset: 0x10 */
  __IO T_UINT32 AHB2RSTR;      /* RCC AHB2 peripheral reset register, Address offset: 0x14 */
  __IO T_UINT32 AHB3RSTR;      /* RCC AHB3 peripheral reset register, Address offset: 0x18 */
  T_UINT32      RESERVED0;     /* Reserved, 0x1C */
  __IO T_UINT32 APB1RSTR;      /* RCC APB1 peripheral reset register, Address offset: 0x20 */
  __IO T_UINT32 APB2RSTR;      /* RCC APB2 peripheral reset register, Address offset: 0x24 */
  T_UINT32      RESERVED1[2];  /* Reserved, 0x28-0x2C */
  __IO T_UINT32 AHB1ENR;       /* RCC AHB1 peripheral clock register, Address offset: 0x30 */
  __IO T_UINT32 AHB2ENR;       /* RCC AHB2 peripheral clock register, Address offset: 0x34 */
  __IO T_UINT32 AHB3ENR;       /* RCC AHB3 peripheral clock register, Address offset: 0x38 */
  T_UINT32      RESERVED2;     /* Reserved, 0x3C */
  __IO T_UINT32 APB1ENR;       /* RCC APB1 peripheral clock enable register, Address offset:0x40 */
  __IO T_UINT32 APB2ENR;       /* RCC APB2 peripheral clock enable register, Address offset:0x44 */
  T_UINT32      RESERVED3[2];  /* Reserved, 0x48-0x4C */
  /* RCC AHB1 peripheral clock enable in low power mode register, Address offset: 0x50 */
  __IO T_UINT32 AHB1LPENR;
  /* RCC AHB2 peripheral clock enable in low power mode register, Address offset: 0x54 */
  __IO T_UINT32 AHB2LPENR;
  /* RCC AHB3 peripheral clock enable in low power mode register, Address offset: 0x58 */
  __IO T_UINT32 AHB3LPENR;
  T_UINT32      RESERVED4;     /* Reserved, 0x5C */
  /* RCC APB1 peripheral clock enable in low power mode register, Address offset: 0x60 */
  __IO T_UINT32 APB1LPENR;
  /* RCC APB2 peripheral clock enable in low power mode register, Address offset: 0x64 */
  __IO T_UINT32 APB2LPENR;
  T_UINT32      RESERVED5[2];  /* Reserved, 0x68-0x6C */
  __IO T_UINT32 BDCR;          /* RCC Backup domain control register, Address offset: 0x70 */
  __IO T_UINT32 CSR;           /* RCC clock control & status register, Address offset: 0x74 */
  T_UINT32      RESERVED6[2];  /* Reserved, 0x78-0x7C */
  /* RCC spread spectrum clock generation register, Address offset: 0x80 */
  __IO T_UINT32 SSCGR;
  __IO T_UINT32 PLLI2SCFGR;    /* RCC PLLI2S configuration register, Address offset: 0x84 */
  __IO T_UINT32 PLLSAICFGR;    /* RCC PLLSAI configuration register, Address offset: 0x88 */
  /* RCC Dedicated Clocks configuration register1, Address offset: 0x8C */
  __IO T_UINT32 DCKCFGR1;
  /* RCC Dedicated Clocks configuration register 2, Address offset: 0x90 */
  __IO T_UINT32 DCKCFGR2;
...
typedef struct
{
  __IO T_UINT32 TR;         /* RTC time register, Address offset: 0x00 */
  __IO T_UINT32 DR;         /* RTC date register, Address offset: 0x04 */
  __IO T_UINT32 CR;         /* RTC control register, Address offset: 0x08 */
  __IO T_UINT32 ISR;        /* RTC initialization and status register, Address offset: 0x0C */
  __IO T_UINT32 PRER;       /* RTC prescaler register, Address offset: 0x10 */
  __IO T_UINT32 WUTR;       /* RTC wakeup timer register, Address offset: 0x14 */
       T_UINT32 reserved;   /* Reserved  */
  __IO T_UINT32 ALRMAR;     /* RTC alarm A register, Address offset: 0x1C */
  __IO T_UINT32 ALRMBR;     /* RTC alarm B register, Address offset: 0x20 */
  __IO T_UINT32 WPR;        /* RTC write protection register, Address offset: 0x24 */
  __IO T_UINT32 SSR;        /* RTC sub second register, Address offset: 0x28 */
  __IO T_UINT32 SHIFTR;     /* RTC shift control register, Address offset: 0x2C */
  __IO T_UINT32 TSTR;       /* RTC time stamp time register, Address offset: 0x30 */
  __IO T_UINT32 TSDR;       /* RTC time stamp date register, Address offset: 0x34 */
  __IO T_UINT32 TSSSR;      /* RTC time-stamp sub second register, Address offset: 0x38 */
  __IO T_UINT32 CALR;       /* RTC calibration register, Address offset: 0x3C */
  __IO T_UINT32 TAMPCR;     /* RTC tamper configuration register, Address offset: 0x40 */
  __IO T_UINT32 ALRMASSR;   /* RTC alarm A sub second register, Address offset: 0x44 */
  __IO T_UINT32 ALRMBSSR;   /* RTC alarm B sub second register, Address offset: 0x48 */
  __IO T_UINT32 OR;         /* RTC option register, Address offset: 0x4C */
  __IO T_UINT32 BKP0R;      /* RTC backup register 0, Address offset: 0x50 */
  __IO T_UINT32 BKP1R;      /* RTC backup register 1, Address offset: 0x54 */
  __IO T_UINT32 BKP2R;      /* RTC backup register 2, Address offset: 0x58 */
  __IO T_UINT32 BKP3R;      /* RTC backup register 3, Address offset: 0x5C */
  __IO T_UINT32 BKP4R;      /* RTC backup register 4, Address offset: 0x60 */
  __IO T_UINT32 BKP5R;      /* RTC backup register 5, Address offset: 0x64 */
  __IO T_UINT32 BKP6R;      /* RTC backup register 6, Address offset: 0x68 */
  __IO T_UINT32 BKP7R;      /* RTC backup register 7, Address offset: 0x6C */
  __IO T_UINT32 BKP8R;      /* RTC backup register 8, Address offset: 0x70 */
  __IO T_UINT32 BKP9R;      /* RTC backup register 9, Address offset: 0x74 */
  __IO T_UINT32 BKP10R;     /* RTC backup register 10, Address offset: 0x78 */
  __IO T_UINT32 BKP11R;     /* RTC backup register 11, Address offset: 0x7C */
  __IO T_UINT32 BKP12R;     /* RTC backup register 12, Address offset: 0x80 */
  __IO T_UINT32 BKP13R;     /* RTC backup register 13, Address offset: 0x84 */
  __IO T_UINT32 BKP14R;     /* RTC backup register 14, Address offset: 0x88 */
  __IO T_UINT32 BKP15R;     /* RTC backup register 15, Address offset: 0x8C */
  __IO T_UINT32 BKP16R;     /* RTC backup register 16, Address offset: 0x90 */
  __IO T_UINT32 BKP17R;     /* RTC backup register 17, Address offset: 0x94 */
  __IO T_UINT32 BKP18R;     /* RTC backup register 18, Address offset: 0x98 */
  __IO T_UINT32 BKP19R;     /* RTC backup register 19, Address offset: 0x9C */
  __IO T_UINT32 BKP20R;     /* RTC backup register 20, Address offset: 0xA0 */
  __IO T_UINT32 BKP21R;     /* RTC backup register 21, Address offset: 0xA4 */
  __IO T_UINT32 BKP22R;     /* RTC backup register 22, Address offset: 0xA8 */
  __IO T_UINT32 BKP23R;     /* RTC backup register 23, Address offset: 0xAC */
  __IO T_UINT32 BKP24R;     /* RTC backup register 24, Address offset: 0xB0 */
  __IO T_UINT32 BKP25R;     /* RTC backup register 25, Address offset: 0xB4 */
  __IO T_UINT32 BKP26R;     /* RTC backup register 26, Address offset: 0xB8 */
  __IO T_UINT32 BKP27R;     /* RTC backup register 27, Address offset: 0xBC */
  __IO T_UINT32 BKP28R;     /* RTC backup register 28, Address offset: 0xC0 */
  __IO T_UINT32 BKP29R;     /* RTC backup register 29, Address offset: 0xC4 */
  __IO T_UINT32 BKP30R;     /* RTC backup register 30, Address offset: 0xC8 */
  __IO T_UINT32 BKP31R;     /* RTC backup register 31, Address offset: 0xCC */
} T_RTC;

/* @brief Serial Audio Interface */
typedef struct
{
  __IO T_UINT32 GCR;      /* SAI global configuration register, Address offset: 0x00 */
} T_SAI;

typedef struct
{
  __IO T_UINT32 CR1;      /* SAI block x configuration register 1, Address offset: 0x04 */
  __IO T_UINT32 CR2;      /* SAI block x configuration register 2, Address offset: 0x08 */
  __IO T_UINT32 FRCR;     /* SAI block x frame configuration register, Address offset: 0x0C */
  __IO T_UINT32 SLOTR;    /* SAI block x slot register, Address offset: 0x10 */
  __IO T_UINT32 IMR;      /* SAI block x interrupt mask register, Address offset: 0x14 */
  __IO T_UINT32 SR;       /* SAI block x status register, Address offset: 0x18 */
  __IO T_UINT32 CLRFR;    /* SAI block x clear flag register, Address offset: 0x1C */
  __IO T_UINT32 DR;       /* SAI block x data register, Address offset: 0x20 */
} T_SAI_BLOCK;

/* @brief SPDIF-RX Interface */
typedef struct
{
  __IO T_UINT32   CR;           /* Control register,                   Address offset: 0x00 */
  __IO T_UINT32   IMR;          /* Interrupt mask register,            Address offset: 0x04 */
  __IO T_UINT32   SR;           /* Status register,                    Address offset: 0x08 */
  __IO T_UINT32   IFCR;         /* Interrupt Flag Clear register,      Address offset: 0x0C */
  __IO T_UINT32   DR;           /* Data input register,                Address offset: 0x10 */
  __IO T_UINT32   CSR;          /* Channel Status register,            Address offset: 0x14 */
  __IO T_UINT32   DIR;          /* Debug Information register,         Address offset: 0x18 */
} T_SPDIFRX;

/* @brief SD host Interface */
typedef struct
{
  __IO T_UINT32 POWER;          /* SDMMC power control register,    Address offset: 0x00 */
  __IO T_UINT32 CLKCR;          /* SDMMClock control register,     Address offset: 0x04 */
  __IO T_UINT32 ARG;            /* SDMMC argument register,         Address offset: 0x08 */
  __IO T_UINT32 CMD;            /* SDMMC command register,          Address offset: 0x0C */
  __I T_UINT32  RESPCMD;        /* SDMMC command response register, Address offset: 0x10 */
  __I T_UINT32  RESP1;          /* SDMMC response 1 register,       Address offset: 0x14 */
  __I T_UINT32  RESP2;          /* SDMMC response 2 register,       Address offset: 0x18 */
  __I T_UINT32  RESP3;          /* SDMMC response 3 register,       Address offset: 0x1C */
  __I T_UINT32  RESP4;          /* SDMMC response 4 register,       Address offset: 0x20 */
  __IO T_UINT32 DTIMER;         /* SDMMC data timer register,       Address offset: 0x24 */
  __IO T_UINT32 DLEN;           /* SDMMC data length register,      Address offset: 0x28 */
  __IO T_UINT32 DCTRL;          /* SDMMC data control register,     Address offset: 0x2C */
  __I T_UINT32  DCOUNT;         /* SDMMC data counter register,     Address offset: 0x30 */
  __I T_UINT32  STA;            /* SDMMC status register,           Address offset: 0x34 */
  __IO T_UINT32 ICR;            /* SDMMC interrupt clear register,  Address offset: 0x38 */
  __IO T_UINT32 MASK;           /* SDMMC mask register,             Address offset: 0x3C */
  T_UINT32      RESERVED0[2];   /* Reserved, 0x40-0x44 */
  __I T_UINT32  FIFOCNT;        /* SDMMC FIFO counter register,     Address offset: 0x48 */
  T_UINT32      RESERVED1[13];  /* Reserved, 0x4C-0x7C */
  __IO T_UINT32 FIFO;           /* SDMMC data FIFO register,        Address offset: 0x80 */
} T_SDMMC;

/* @brief Serial Peripheral Interface */
typedef struct
{
  __IO T_UINT32 CR1;      /* SPI control register 1 (not used in I2S mode), Address offset: 0x00 */
  __IO T_UINT32 CR2;        /* SPI control register 2, Address offset: 0x04 */
  __IO T_UINT32 SR;         /* SPI status register, Address offset: 0x08 */
  __IO T_UINT32 DR;         /* SPI data register, Address offset: 0x0C */
  /* SPI CRC polynomial register (not used in I2S mode), Address offset: 0x10 */
  __IO T_UINT32 CRCPR;
  __IO T_UINT32 RXCRCR;     /* SPI RX CRC register (not used in I2S mode), Address offset: 0x14 */
  __IO T_UINT32 TXCRCR;     /* SPI TX CRC register (not used in I2S mode), Address offset: 0x18 */
  __IO T_UINT32 I2SCFGR;    /* SPI_I2S configuration register, Address offset: 0x1C */
  __IO T_UINT32 I2SPR;      /* SPI_I2S prescaler register, Address offset: 0x20 */
} T_SPI;

/* @brief QUAD Serial Peripheral Interface */
typedef struct
{
  __IO T_UINT32 CR;       /* QUADSPI Control register, Address offset: 0x00 */
  __IO T_UINT32 DCR;      /* QUADSPI Device Configuration register, Address offset: 0x04 */
  __IO T_UINT32 SR;       /* QUADSPI Status register, Address offset: 0x08 */
  __IO T_UINT32 FCR;      /* QUADSPI Flag Clear register, Address offset: 0x0C */
  __IO T_UINT32 DLR;      /* QUADSPI Data Length register, Address offset: 0x10 */
  __IO T_UINT32 CCR;      /* QUADSPI Communication Configuration register, Address offset: 0x14 */
  __IO T_UINT32 AR;       /* QUADSPI Address register, Address offset: 0x18 */
  __IO T_UINT32 ABR;      /* QUADSPI Alternate Bytes register, Address offset: 0x1C */
  __IO T_UINT32 DR;       /* QUADSPI Data register, Address offset: 0x20 */
  __IO T_UINT32 PSMKR;    /* QUADSPI Polling Status Mask register, Address offset: 0x24 */
  __IO T_UINT32 PSMAR;    /* QUADSPI Polling Status Match register, Address offset: 0x28 */
  __IO T_UINT32 PIR;      /* QUADSPI Polling Interval register, Address offset: 0x2C */
  __IO T_UINT32 LPTR;     /* QUADSPI Low Power Timeout register, Address offset: 0x30 */
} T_QUADSP;

/* @brief TIM */
typedef struct
{
  __IO T_UINT32 CR1;         /* TIM control register 1,              Address offset: 0x00 */
  __IO T_UINT32 CR2;         /* TIM control register 2,              Address offset: 0x04 */
  __IO T_UINT32 SMCR;        /* TIM slave mode control register,     Address offset: 0x08 */
  __IO T_UINT32 DIER;        /* TIM DMA/interrupt enable register,   Address offset: 0x0C */
  __IO T_UINT32 SR;          /* TIM status register,                 Address offset: 0x10 */
  __IO T_UINT32 EGR;         /* TIM event generation register,       Address offset: 0x14 */
  __IO T_UINT32 CCMR1;       /* TIM capture/compare mode register 1, Address offset: 0x18 */
  __IO T_UINT32 CCMR2;       /* TIM capture/compare mode register 2, Address offset: 0x1C */
  __IO T_UINT32 CCER;        /* TIM capture/compare enable register, Address offset: 0x20 */
  __IO T_UINT32 CNT;         /* TIM counter register,                Address offset: 0x24 */
  __IO T_UINT32 PSC;         /* TIM prescaler,                       Address offset: 0x28 */
  __IO T_UINT32 ARR;         /* TIM auto-reload register,            Address offset: 0x2C */
  __IO T_UINT32 RCR;         /* TIM repetition counter register,     Address offset: 0x30 */
  __IO T_UINT32 CCR1;        /* TIM capture/compare register 1,      Address offset: 0x34 */
  __IO T_UINT32 CCR2;        /* TIM capture/compare register 2,      Address offset: 0x38 */
  __IO T_UINT32 CCR3;        /* TIM capture/compare register 3,      Address offset: 0x3C */
  __IO T_UINT32 CCR4;        /* TIM capture/compare register 4,      Address offset: 0x40 */
  __IO T_UINT32 BDTR;        /* TIM break and dead-time register,    Address offset: 0x44 */
  __IO T_UINT32 DCR;         /* TIM DMA control register,            Address offset: 0x48 */
  __IO T_UINT32 DMAR;        /* TIM DMA address for full transfer,   Address offset: 0x4C */
  __IO T_UINT32 OR;          /* TIM option register,                 Address offset: 0x50 */
  __IO T_UINT32 CCMR3;       /* TIM capture/compare mode register 3, Address offset: 0x54 */
  __IO T_UINT32 CCR5;        /* TIM capture/compare mode register5,  Address offset: 0x58 */
  __IO T_UINT32 CCR6;        /* TIM capture/compare mode register6,  Address offset: 0x5C */
...
typedef struct
{
  __IO T_UINT32 ISR;      /* LPTIM Interrupt and Status register, Address offset: 0x00 */
  __IO T_UINT32 ICR;      /* LPTIM Interrupt Clear register, Address offset: 0x04 */
  __IO T_UINT32 IER;      /* LPTIM Interrupt Enable register, Address offset: 0x08 */
  __IO T_UINT32 CFGR;     /* LPTIM Configuration register, Address offset: 0x0C */
  __IO T_UINT32 CR;       /* LPTIM Control register, Address offset: 0x10 */
  __IO T_UINT32 CMP;      /* LPTIM Compare register, Address offset: 0x14 */
  __IO T_UINT32 ARR;      /* LPTIM Autoreload register, Address offset: 0x18 */
  __IO T_UINT32 CNT;      /* LPTIM Counter register, Address offset: 0x1C */
} T_LPTIM;

/* @brief Universal Synchronous Asynchronous Receiver Transmitter */
typedef struct
{
  __IO T_UINT32 CR1;    /* USART Control register 1,                 Address offset: 0x00 */
  __IO T_UINT32 CR2;    /* USART Control register 2,                 Address offset: 0x04 */
  __IO T_UINT32 CR3;    /* USART Control register 3,                 Address offset: 0x08 */
  __IO T_UINT32 BRR;    /* USART Baud rate register,                 Address offset: 0x0C */
  __IO T_UINT32 GTPR;   /* USART Guard time and prescaler register,  Address offset: 0x10 */
  __IO T_UINT32 RTOR;   /* USART Receiver Time Out register,         Address offset: 0x14 */
  __IO T_UINT32 RQR;    /* USART Request register,                   Address offset: 0x18 */
  __IO T_UINT32 ISR;    /* USART Interrupt and status register,      Address offset: 0x1C */
  __IO T_UINT32 ICR;    /* USART Interrupt flag Clear register,      Address offset: 0x20 */
  __IO T_UINT32 RDR;    /* USART Receive Data register,              Address offset: 0x24 */
  __IO T_UINT32 TDR;    /* USART Transmit Data register,             Address offset: 0x28 */
} T_USART;

/* @brief Window WATCHDOG */
typedef struct
{
  __IO T_UINT32 CR;   /* WWDG Control register,       Address offset: 0x00 */
  __IO T_UINT32 CFR;  /* WWDG Configuration register, Address offset: 0x04 */
  __IO T_UINT32 SR;   /* WWDG Status register,        Address offset: 0x08 */
} T_WWDG;

/* @brief RNG */
typedef struct
{
  __IO T_UINT32 CR;  /* RNG control register, Address offset: 0x00 */
  __IO T_UINT32 SR;  /* RNG status register,  Address offset: 0x04 */
  __IO T_UINT32 DR;  /* RNG data register,    Address offset: 0x08 */
} T_RNG;

/* @brief USB_OTG_Core_Registers */
typedef struct
{
 __IO T_UINT32 GOTGCTL;               /* USB_OTG Control and Status Register          000h */
  __IO T_UINT32 GOTGINT;              /* USB_OTG Interrupt Register                   004h */
  __IO T_UINT32 GAHBCFG;              /* Core AHB Configuration Register              008h */
  __IO T_UINT32 GUSBCFG;              /* Core USB Configuration Register              00Ch */
  __IO T_UINT32 GRSTCTL;              /* Core Reset Register                          010h */
  __IO T_UINT32 GINTSTS;              /* Core Interrupt Register                      014h */
  __IO T_UINT32 GINTMSK;              /* Core Interrupt Mask Register                 018h */
  __IO T_UINT32 GRXSTSR;              /* Receive Sts Q Read Register                  01Ch */
  __IO T_UINT32 GRXSTSP;              /* Receive Sts Q Read & POP Register            020h */
  __IO T_UINT32 GRXFSIZ;              /* Receive FIFO Size Register                   024h */
  __IO T_UINT32 DIEPTXF0_HNPTXFSIZ;   /* EP0 / Non Periodic Tx FIFO Size Register     028h */
  __IO T_UINT32 HNPTXSTS;             /* Non Periodic Tx FIFO/Queue Sts reg           02Ch */
  T_UINT32 Reserved30[2];             /* Reserved                                     030h */
  __IO T_UINT32 GCCFG;                /* General Purpose IO Register                  038h */
  __IO T_UINT32 CID;                  /* User ID Register                             03Ch */
  T_UINT32  Reserved5[3];             /* Reserved                                040h-048h */
  __IO T_UINT32 GHWCFG3;              /* User HW config3                              04Ch */
  T_UINT32  Reserved6;                /* Reserved                                     050h */
  __IO T_UINT32 GLPMCFG;              /* LPM Register                                 054h */
  __IO T_UINT32 GPWRDN;               /* Power Down Register                          058h */
  __IO T_UINT32 GDFIFOCFG;            /* DFIFO Software Config Register               05Ch */
   __IO T_UINT32 GADPCTL;             /* ADP Timer, Control and Status Register       60Ch */
    T_UINT32  Reserved43[39];         /* Reserved                                058h-0FFh */
  __IO T_UINT32 HPTXFSIZ;             /* Host Periodic Tx FIFO Size Reg               100h */
  __IO T_UINT32 DIEPTXF[0x0F];        /* dev Periodic Transmit FIFO */
} T_USB_OTG_GLOBAL;

/* @brief USB_OTG_device_Registers */
typedef struct
{
  __IO T_UINT32 DCFG;            /* dev Configuration Register   800h */
  __IO T_UINT32 DCTL;            /* dev Control Register         804h */
  __IO T_UINT32 DSTS;            /* dev Status Register (RO)     808h */
  T_UINT32 Reserved0C;           /* Reserved                     80Ch */
  __IO T_UINT32 DIEPMSK;         /* dev IN Endpoint Mask         810h */
  __IO T_UINT32 DOEPMSK;         /* dev OUT Endpoint Mask        814h */
  __IO T_UINT32 DAINT;           /* dev All Endpoints Itr Reg    818h */
  __IO T_UINT32 DAINTMSK;        /* dev All Endpoints Itr Mask   81Ch */
  T_UINT32  Reserved20;          /* Reserved                     820h */
  T_UINT32 Reserved9;            /* Reserved                     824h */
  __IO T_UINT32 DVBUSDIS;        /* dev VBUS discharge Register  828h */
  __IO T_UINT32 DVBUSPULSE;      /* dev VBUS Pulse Register      82Ch */
  __IO T_UINT32 DTHRCTL;         /* dev threshold                830h */
  __IO T_UINT32 DIEPEMPMSK;      /* dev empty msk                834h */
  __IO T_UINT32 DEACHINT;        /* dedicated EP interrupt       838h */
  __IO T_UINT32 DEACHMSK;        /* dedicated EP msk             83Ch */
  T_UINT32 Reserved40;           /* dedicated EP mask            840h */
  __IO T_UINT32 DINEP1MSK;       /* dedicated EP mask            844h */
  T_UINT32  Reserved44[15];      /* Reserved                 844-87Ch */
  __IO T_UINT32 DOUTEP1MSK;      /* dedicated EP msk             884h */
} T_USB_OTG_DEVICE;

/* @brief USB_OTG_IN_Endpoint-Specific_Register */
typedef struct
{
  __IO T_UINT32 DIEPCTL;           /* dev IN Endpoint Control Reg    900h + (ep_num * 20h) + 00h */
  T_UINT32 Reserved04;             /* Reserved                       900h + (ep_num * 20h) + 04h */
  __IO T_UINT32 DIEPINT;           /* dev IN Endpoint Itr Reg        900h + (ep_num * 20h) + 08h */
  T_UINT32 Reserved0C;             /* Reserved                       900h + (ep_num * 20h) + 0Ch */
  __IO T_UINT32 DIEPTSIZ;          /* IN Endpoint Txfer Size         900h + (ep_num * 20h) + 10h */
  __IO T_UINT32 DIEPDMA;           /* IN Endpoint DMA Address Reg    900h + (ep_num * 20h) + 14h */
  __IO T_UINT32 DTXFSTS;           /* IN Endpoint Tx FIFO Status Reg 900h + (ep_num * 20h) + 18h */
  T_UINT32 Reserved18;             /* Reserved  900h+(ep_num*20h)+1Ch-900h+ (ep_num * 20h) + 1Ch */
} T_USB_OTG_INENDPOINT;

/* @brief USB_OTG_OUT_Endpoint-Specific_Registers */
typedef struct
{
  __IO T_UINT32 DOEPCTL;       /* dev OUT Endpoint Control Reg B00h + (ep_num * 20h) + 00h */
  T_UINT32 Reserved04;         /* Reserved B00h + (ep_num * 20h) + 04h */
  __IO T_UINT32 DOEPINT;       /* dev OUT Endpoint Itr Reg B00h + (ep_num * 20h) + 08h */
  T_UINT32 Reserved0C;         /* Reserved B00h + (ep_num * 20h) + 0Ch */
  __IO T_UINT32 DOEPTSIZ;      /* dev OUT Endpoint Txfer Size B00h + (ep_num * 20h) + 10h */
  __IO T_UINT32 DOEPDMA;       /* dev OUT Endpoint DMA Address B00h + (ep_num * 20h) + 14h */
  /* Reserved B00h + (ep_num * 20h) + 18h - B00h + (ep_num * 20h) + 1Ch */
  T_UINT32 Reserved18[2];
} T_USB_OTG_OUTENDPOINT;

/* @brief USB_OTG_Host_Mode_Register_Structures */
typedef struct
{
  __IO T_UINT32 HCFG;             /* Host Configuration Register          400h */
  __IO T_UINT32 HFIR;             /* Host Frame Interval Register         404h */
  __IO T_UINT32 HFNUM;            /* Host Frame Nbr/Frame Remaining       408h */
  T_UINT32 Reserved40C;           /* Reserved                             40Ch */
  __IO T_UINT32 HPTXSTS;          /* Host Periodic Tx FIFO/ Queue Status  410h */
  __IO T_UINT32 HAINT;            /* Host All Channels Interrupt Register 414h */
  __IO T_UINT32 HAINTMSK;         /* Host All Channels Interrupt Mask     418h */
} T_USB_OTG_HOST;

/* @brief USB_OTG_Host_Channel_Specific_Registers */
typedef struct
{
  __IO T_UINT32 HCCHAR;           /* Host Channel Characteristics Register    500h */
  __IO T_UINT32 HCSPLT;           /* Host Channel Split Control Register      504h */
  __IO T_UINT32 HCINT;            /* Host Channel Interrupt Register          508h */
  __IO T_UINT32 HCINTMSK;         /* Host Channel Interrupt Mask Register     50Ch */
  __IO T_UINT32 HCTSIZ;           /* Host Channel Transfer Size Register      510h */
  __IO T_UINT32 HCDMA;            /* Host Channel DMA Address Register        514h */
  T_UINT32 Reserved[2];           /* Reserved   */
} T_USB_OTG_HOSTCHANNEL;
...
#define TIM2                ((T_TIM *) TIM2_BASE)
#define TIM3                ((T_TIM *) TIM3_BASE)
#define TIM4                ((T_TIM *) TIM4_BASE)
#define TIM5                ((T_TIM *) TIM5_BASE)
#define TIM6                ((T_TIM *) TIM6_BASE)
#define TIM7                ((T_TIM *) TIM7_BASE)
#define TIM12               ((T_TIM *) TIM12_BASE)
#define TIM13               ((T_TIM *) TIM13_BASE)
#define TIM14               ((T_TIM *) TIM14_BASE)
#define LPTIM1              ((T_LPTIM *) LPTIM1_BASE)
#define RTC                 ((T_RTC *) RTC_BASE)
#define WWDG                ((T_WWDG *) WWDG_BASE)
#define IWDG                ((T_IWDG *) IWDG_BASE)
#define SPI2                ((T_SPI *) SPI2_BASE)
#define SPI3                ((T_SPI *) SPI3_BASE)
#define SPDIFRX             ((T_SPDIFRX *) SPDIFRX_BASE)
#define USART2              ((T_USART *) USART2_BASE)
#define USART3              ((T_USART *) USART3_BASE)
#define UART4               ((T_USART *) UART4_BASE)
#define UART5               ((T_USART *) UART5_BASE)
#define I2C1                ((T_I2C *) I2C1_BASE)
#define I2C2                ((T_I2C *) I2C2_BASE)
#define I2C3                ((T_I2C *) I2C3_BASE)
#define I2C4                ((T_I2C *) I2C4_BASE)
#define CAN1                ((T_CAN *) CAN1_BASE)
#define CAN2                ((T_CAN *) CAN2_BASE)
#define CEC                 ((T_CEC *) CEC_BASE)
#define PWR                 ((T_PWR *) PWR_BASE)
#define DAC                 ((T_DAC *) DAC_BASE)
#define UART7               ((T_USART *) UART7_BASE)
#define UART8               ((T_USART *) UART8_BASE)
#define TIM1                ((T_TIM *) TIM1_BASE)
#define TIM8                ((T_TIM *) TIM8_BASE)
#define USART1              ((T_USART *) USART1_BASE)
#define USART6              ((T_USART *) USART6_BASE)
#define ADC                 ((T_ADC_COMMON *) ADC_BASE)
#define ADC1                ((T_ADC *) ADC1_BASE)
#define ADC2                ((T_ADC *) ADC2_BASE)
#define ADC3                ((T_ADC *) ADC3_BASE)
#define SDMMC1              ((T_SDMMC *) SDMMC1_BASE)
#define SPI1                ((T_SPI *) SPI1_BASE)
#define SPI4                ((T_SPI *) SPI4_BASE)
#define SYSCFG              ((T_SYSCFG *) SYSCFG_BASE)
#define EXTI                ((T_EXTI *) EXTI_BASE)
#define TIM9                ((T_TIM *) TIM9_BASE)
#define TIM10               ((T_TIM *) TIM10_BASE)
#define TIM11               ((T_TIM *) TIM11_BASE)
#define SPI5                ((T_SPI *) SPI5_BASE)
#define SPI6                ((T_SPI *) SPI6_BASE)
#define SAI1                ((T_SAI *) SAI1_BASE)
#define SAI2                ((T_SAI *) SAI2_BASE)
#define SAI1_BLOCK_A        ((T_SAI_BLOCK *)SAI1_BLOCK_A_BASE)
#define SAI1_BLOCK_B        ((T_SAI_BLOCK *)SAI1_BLOCK_B_BASE)
#define SAI2_BLOCK_A        ((T_SAI_BLOCK *)SAI2_BLOCK_A_BASE)
#define SAI2_BLOCK_B        ((T_SAI_BLOCK *)SAI2_BLOCK_B_BASE)
#define LTDC                ((T_LTDC *)LTDC_BASE)
#define LTDC_LAYER1         ((T_LTDC_LAYER *)LTDC_LAYER1_BASE)
#define LTDC_LAYER2         ((T_LTDC_LAYER *)LTDC_LAYER2_BASE)
#define GPIOA               ((T_GPIO *) GPIOA_BASE)
#define GPIOB               ((T_GPIO *) GPIOB_BASE)
#define GPIOC               ((T_GPIO *) GPIOC_BASE)
#define GPIOD               ((T_GPIO *) GPIOD_BASE)
#define GPIOE               ((T_GPIO *) GPIOE_BASE)
#define GPIOF               ((T_GPIO *) GPIOF_BASE)
#define GPIOG               ((T_GPIO *) GPIOG_BASE)
#define GPIOH               ((T_GPIO *) GPIOH_BASE)
#define GPIOI               ((T_GPIO *) GPIOI_BASE)
#define GPIOJ               ((T_GPIO *) GPIOJ_BASE)
#define GPIOK               ((T_GPIO *) GPIOK_BASE)
#define CRC                 ((T_CRC *) CRC_BASE)
#define RCC                 ((T_RCC *) RCC_BASE)
#define FLASH               ((T_FLASH *) FLASH_R_BASE)
#define DMA1                ((T_DMA *) DMA1_BASE)
#define DMA1_STREAM0        ((T_DMA_STREAM *) DMA1_STREAM0_BASE)
#define DMA1_STREAM1        ((T_DMA_STREAM *) DMA1_STREAM1_BASE)
#define DMA1_STREAM2        ((T_DMA_STREAM *) DMA1_STREAM2_BASE)
#define DMA1_STREAM3        ((T_DMA_STREAM *) DMA1_STREAM3_BASE)
#define DMA1_STREAM4        ((T_DMA_STREAM *) DMA1_STREAM4_BASE)
#define DMA1_STREAM5        ((T_DMA_STREAM *) DMA1_STREAM5_BASE)
#define DMA1_STREAM6        ((T_DMA_STREAM *) DMA1_STREAM6_BASE)
#define DMA1_STREAM7        ((T_DMA_STREAM *) DMA1_STREAM7_BASE)
#define DMA2                ((T_DMA *) DMA2_BASE)
#define DMA2_STREAM0        ((T_DMA_STREAM *) DMA2_STREAM0_BASE)
#define DMA2_STREAM1        ((T_DMA_STREAM *) DMA2_STREAM1_BASE)
#define DMA2_STREAM2        ((T_DMA_STREAM *) DMA2_STREAM2_BASE)
#define DMA2_STREAM3        ((T_DMA_STREAM *) DMA2_STREAM3_BASE)
#define DMA2_STREAM4        ((T_DMA_STREAM *) DMA2_STREAM4_BASE)
#define DMA2_STREAM5        ((T_DMA_STREAM *) DMA2_STREAM5_BASE)
#define DMA2_STREAM6        ((T_DMA_STREAM *) DMA2_STREAM6_BASE)
#define DMA2_STREAM7        ((T_DMA_STREAM *) DMA2_STREAM7_BASE)
#define ETH                 ((T_ETH *) ETH_BASE)
#define DMA2D               ((T_DMA2D *)DMA2D_BASE)
#define DCMI                ((T_DCMI *) DCMI_BASE)
#define RNG                 ((T_RNG *) RNG_BASE)
#define FMC_BANK1           ((T_FMC_BANK1 *) FMC_BANK1_R_BASE)
#define FMC_BANK1E          ((T_FMC_BANK1E *) FMC_BANK1E_R_BASE)
#define FMC_BANK3           ((T_FMC_BANK3 *) FMC_BANK3_R_BASE)
#define FMC_BANK5_6         ((T_FMC_BANK5_6 *) FMC_BANK5_6_R_BASE)
#define QUADSPI             ((T_QUADSP *) QSPI_R_BASE)
#define DBGMCU              ((T_DBGMCU *) DBGMCU_BASE)
#define USB_OTG_FS          ((T_USB_OTG_GLOBAL *) USB_OTG_FS_PERIPH_BASE)
#define USB_OTG_HS          ((T_USB_OTG_GLOBAL *) USB_OTG_HS_PERIPH_BASE)
...
#define  ADC_JDR1_JDATA                      ((T_UINT16)0xFFFFU)            /*Injected data */

/*******************  Bit definition for ADC_JDR2 register  *******************/
#define  ADC_JDR2_JDATA                      ((T_UINT16)0xFFFFU)            /*Injected data */

/*******************  Bit definition for ADC_JDR3 register  *******************/
#define  ADC_JDR3_JDATA                      ((T_UINT16)0xFFFFU)            /*Injected data */

/*******************  Bit definition for ADC_JDR4 register  *******************/
#define  ADC_JDR4_JDATA                      ((T_UINT16)0xFFFFU)            /*Injected data */
...
#define  CAN_FMR_FINIT                       ((T_UINT8)0x01U)               /*Filter Init Mode */
...
#define  TIM_RCR_REP                         ((T_UINT8)0xFFU)      /*Repetition Counter Value */
...
#define  TIM_CCR6_CCR6                  ((T_UINT16)0xFFFFU)   /*Capture/Compare 6 Value */
...
#define  DBGMCU_APB1_FZ_I2C1_SMBUS_TMOUT        0x00200000U
#define  DBGMCU_APB1_FZ_I2C2_SMBUS_TMOUT        0x00400000U
#define  DBGMCU_APB1_FZ_I2C3_SMBUS_TMOUT        0x00800000U
 ...
 */
#define ETH_MACCR_BL         0x00000060U
...
#define ETH_MACFFR_PCF_FORWARDALL         0x00000080U
/* MAC forwards control frames that pass the Address Filter. */
#define ETH_MACFFR_PCF_FRWDPASSADRFILTER 0x000000C0U
...
/*
 * Eight sequential Writes to this address (offset 0x28) will write all Wake-UpFrame Filter Reg.
 * Eight sequential Reads from this address (offset 0x28) will read all Wake-UpFrame Filter Reg.
 */
...
#define ETH_MMCTGFSCCR_TGFSCC     0xFFFFFFFFU

/*
 * Bit definition for Ethernet MMC Transmitted Good Frames
 * after More than a Single Collision Counter Register
 */
/* No. of successfully transmitted frames after more than a single collision in Half-duplex mode.*/
#define ETH_MMCTGFMSCCR_TGFMSCC   0xFFFFFFFFU
...
#define ETH_MMCRFAECR_RFAEC  0xFFFFFFFFU
...
#define ETH_PTPTSSR_TSSMRME     0x00008000U
...
#define ETH_DMASR_RPS_QUEUING    0x000E0000U
...
#define USB_OTG_GINTSTS_PXFR_INCOPISOOUT       0x00200000U   /* Incomplete periodic transfer */
...
#define IS_TIM_CC1_INSTANCE(__INSTANCE__)   ((TIM1 == (__INSTANCE__))  || \
                                            (TIM2 == (__INSTANCE__))  || \
                                            (TIM3 == (__INSTANCE__))  || \
                                            (TIM4 == (__INSTANCE__))  || \
                                            (TIM5 == (__INSTANCE__))  || \
...
#define IS_TIM_CC3_INSTANCE(__INSTANCE__)   (TIM1 == ((__INSTANCE__)) || \
                                            (TIM2 ==(__INSTANCE__)) || \
                                            (TIM3 ==(__INSTANCE__)) || \
                                            (TIM4 ==(__INSTANCE__)) || \
                                            (TIM5 ==(__INSTANCE__)) || \
...
#define IS_TIM_COMBINED3PHASEPWM_INSTANC(__INSTANCE__) \
                                       (((__INSTANCE__) == TIM1)    || \
                                        ((__INSTANCE__) == TIM8))
...
#define IS_TIM_ADVANCED_INSTANCE(__INSTANCE__) (TIM1 == ((__INSTANCE__)) || \
                                            (TIM8 == (__INSTANCE__)))
